...
class UI:
    ...
    def cliente_adicionar_produto(cls):
        carrinho = Carrinho(cls.cliente_id)  # Cria o carrinho com o ID do cliente logado
        

        
        #lista os ids dos produtos para o cliente saber qual numero precisa digitar e adicionar o produto ao carrinho
        print("Produtos disponíveis:\n")
        produtos = View.produto_listar()
       
        for produto in produtos:
           print(produto)
        #recebe o id do produto para depois adicionar o produto ao carrinho        
        print("Digite o ID do produto que deseja adicionar ao carrinho:")
        id = int(input())
        print("Digite a QUANTIDADE do produto que deseja adicionar ao carrinho:")
        qntd = int(input())
        #View.produto_inserir(desc, prc, est, id_categoria)
        ...
        if produto_selecionado is not None:
            if qntd <= produto_selecionado.estoque:
                dados = {"id_cliente": cls.cliente_id, "id": produto_selecionado.id, "descricao": produto_selecionado.descricao, "quantidade": qntd, "preco": produto_selecionado.preco, "total_a_pagar": qntd*produto_selecionado.preco}
                carrinho.adicionar_produto(dados)
                print(f"O produto {produto_selecionado.descricao} está a sua espera no carrinho!")
            else:
