...
Uma classe em C# é como um "molde" ou "blueprint" para criar objetos. Ela define as propriedades (variáveis) e comportamentos (métodos) que os objetos criados a partir dela terão. É uma forma de organizar o código em entidades que representam coisas do mundo real ou conceitos abstratos.
...
Aqui, Carro é uma classe que tem duas propriedades (cor e modelo) e um método (Dirigir). Você pode criar objetos dessa classe assim:
